 ...
 */
/**
 * The class to create a Purchase object.
 *
 * @author joeyfinkel
 */
public class Purchase {
     ...
     *
     * @return The quantity of itemPrice and quantity.
     */
    public double cost() {
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.quantity) ^ (Double.doubleToLongBits(this.quantity) >>> 32));
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.itemPrice) ^ (Double.doubleToLongBits(this.itemPrice) >>> 32));
        return hash;
    }
    ...
    public String toString() {
        return this.itemName + " | " + this.itemPrice + " | " + this.quantity;
    }
}
